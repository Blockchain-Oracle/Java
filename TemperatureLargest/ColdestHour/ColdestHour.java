package TemperatureLargest.ColdestHour;
...
public class ColdestHour {
    public static void main(String[] args) {
        testAverageTemperatureWithHighHumidityInFile(80, "weather-2013-09-02.csv");
    }
